    ...
    if url:
        try:
            ...
            if es_html(response.text):
                st.error("❌ Este archivo no está compartido correctamente o el enlace no es de descarga directa. Verifica que esté como 'Cualquiera con el enlace puede ver'.")
            else:
